...
<div class="d-flex justify-content-center align-items-center vh-100">
    ...
    <a href="{{ route('perfiles.index') }}" class="btn btn-outline-secondary">
       ...
       <h1 class="text-center mb-4 fw-bold">Editar Perfil</h1>
        ...
        <form action="{{route('perfiles.update', $item->id)}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre" value="{{$item->nombre}}">
            </div>

            <div class="mb-3">
                <label for="descripcion" class="form-label fw-semibold">Descripción del Perfil</label>
                <input type="text" id="descripcion" name="descripcion" class="form-control" placeholder="Descripcion" value="{{$item->descripcion}}">
            </div>
