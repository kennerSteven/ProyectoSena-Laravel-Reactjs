...
import SchemaValidationVisitante from "./Validation/SchemaValidation/SchemaValidationVisitante";
import HandleValidationVisitante from "./Validation/HandleValidation/HandleValidation.visitante";

export default function FormVisitante({ closeModal, usuarioSeleccionado }) {
  const {
    register,
    reset,
    setValue,
  ...
  const { perfiles } = useTipoPerfilFetch("Visitante");
  ...
  const { onSubmit, onError } = HandleValidationVisitante({
    reset,
    perfiles,
    closeModal,
    perfil: "Visitante",
